...
takeout_playerIdentity  (PlayerState pI _ _ _ _ _ _)    =  pI

takeout_gamePhaseState  :: PlayerState -> IO GamePhaseState
takeout_gamePhaseState  (PlayerState _ gs _ _ _ _ _)    =  return gs

takeout_fieldstate      :: PlayerState -> IO FieldState
takeout_fieldstate      (PlayerState _ _ fs _ _ _ _)    =  return fs

takeout_ppuyostate      :: PlayerState -> IO PlayerPuyoState
takeout_ppuyostate      (PlayerState _ _ _ ps _ _ _)    =  return ps

takeout_nextPuyoState   :: PlayerState -> IO NextPuyoState
takeout_nextPuyoState   (PlayerState _ _ _ _ ns _ _)    =  return ns

takeout_scoreState      :: PlayerState -> ScoreState
takeout_scoreState      (PlayerState _ _ _ _ _ sc _)    =  sc

takeout_yokokuState     :: PlayerState -> YokokuState
takeout_yokokuState     (PlayerState _ _ _ _ _ _ ys)    =  ys